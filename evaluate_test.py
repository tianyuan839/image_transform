...
def evaluate_model(model, captions, photo_features, tokenizer, max_length = 40):
    ...
    for key, caption_list in captions.items():
        yhat = generate_caption(model, tokenizer,photo_features)
    ...
    blue2 = corpus_bleu(actual, predicted, weights=(0.5, 0.5, 0.5, 0.5))
...
img_path = 'Flicker8k_Dataset/2647049174_0fb47cee2e.jpg'
evalueateModel(img_path)
